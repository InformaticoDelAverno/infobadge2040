...
// Panel used by this editor firmware (Good Display GDEY029F51H from GxEPD2). Native: 168x384.
GxEPD2_4C<GxEPD2_290c_GDEY029F51H, GxEPD2_290c_GDEY029F51H::HEIGHT> display(
  GxEPD2_290c_GDEY029F51H(/*CS*/ 16, /*DC*/ 14, /*RST*/ 13, /*BUSY*/ 12)
);
MbedSPI badgeSPI(SPI_MISO, SPI_MOSI, SPI_SCK);

// Fixed logical orientation expected by infobadge_editor.py.
static const uint16_t LOGICAL_W = 384;
static const uint16_t LOGICAL_H = 168;
// Physical size for GDEY029F51H with rotation(3): 384x168.
static const uint16_t PHYS_W = 384;
static const uint16_t PHYS_H = 168;
